                            ...
                            <form className="bg-white rounded px-1 lg:px-4 pt-4 pb-4  w-full" onSubmit={onSubmit}>
                                ...
                                <div className="grid grid-cols-2 lg:gap-2">
                                    ...
                                    <div className='grid justify-center'>
                                        ...
                                        <p className="lg:flex justify-end text-sm text-primary-900">Importe: ${detviatico.importe}</p>
                                    </div>
                                ...
                                <div className="grid lg:grid-cols-2 lg:gap-2">
                                    <div className='lg:p-3 px-3'>
                                        <div className='px-2 lg:py-4 py-4'>
                                            <label htmlFor="ciudades" className="block text-sm text-gray-500 dark:text-gray-500">
                                                Origen
                                            </label>
                                            <Controller
                                                control={control}
                                                ...
                                                render={({ field: { onChange, value } }) => (
                                                    <select
                                                        ...
                                                        className="  bg-gray-50 border border-gray-300 text-gray-900
                                                                    text-xs lg:text-sm rounded-lg focus:ring-gray-500 focus:border-gray-500 
                                                                    block w-full p-1.5"
                                                    >
                                                        {ciudades.map((r) => (
                                        ...
                                        <div className='px-2 lg:py-4 py-4'>
                                            <label htmlFor="ciudades2" className="block text-sm text-gray-500 dark:text-gray-500">
                                                Destino
                                            </label>
                                            <Controller
                                                control={control}
                                    ...
                                    <div className='flex lg:px-1'>
                                        ...
                                        <div className='px-1 py-4'>
                                            <label className="block text-sm text-gray-500 dark:text-gray-500"> Salida </label>
                                            <DatePickerField control={control} name='fechaSalida' date={new Date(detviatico.fechaSalida)} manejarCambio={manejarCambio} />
                                        </div>
                                        <div className='px-1 py-4'>
                                            <label className="block text-sm text-gray-500 dark:text-gray-500"> Regreso </label>
                                            <DatePickerField control={control} name='fechaRegreso' date={new Date(detviatico.fechaRegreso)} manejarCambio={manejarCambio} />
                                        </div>
                                        <div className='form-control py-4 px-4 items-center'>
                                            <label htmlFor="diasmrr" className="block text-center text-sm text-gray-500 dark:text-gray-500"> Días  </label>
                                            <input
                                                type="number"
                                                //value={detviatico.dias}
                                                //defaultValue={0}
                                                {...register("diasmrr", {
                                                    valueAsNumber: true,
                                                })}
                                                className="bg-gray-50 border border-gray-300 text-gray-900 text-xs lg:text-sm rounded-lg focus:ring-primary-600
                                                            focus:border-primary-600 w-full p-1"
                                                readOnly />
                                ...
                                <div className='flex lg:p-3 px-2 '>
                                    <div className='w-full'>
                                        <div className='px-2 py-4'>
                                            <label className="block text-sm text-gray-500 dark:text-gray-500"> Titulo de la Comisión </label>
                                            <input {...register("comisiontitulo", { required: true })}
                                                onInput={convertirAMayusculas}
                                                className="bg-gray-50 border border-gray-300 text-gray-900 text-xs lg:text-sm rounded-lg focus:ring-primary-600
                                                            focus:border-primary-600 block w-full p-1" />
                                                {errors.comisiontitulo && <p className='text-red-600 text-xs'>Este campo es requerido!</p>}
                                        </div>
                                        
                                        <div className='px-2 py-4'>
                                            <label className="block text-sm text-gray-500 dark:text-gray-500"> Actividades </label>
                                            <textarea {...register("comisionDetalle", { required: true })} className="resize-none bg-gray-50 border border-gray-300 text-gray-900 text-xs lg:text-sm rounded-lg focus:ring-primary-600
                                            focus:border-primary-600 block p-2 w-full h-28" 
                                            ></textarea>
